		...
		<div id="carousel-container" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox">
		    ...
		    <div class="carousel-item active">
		      <img class="d-block img-fluid carousel-img" src="<?php echo get_theme_mod('slider_image1', get_bloginfo('template_url').'/assets/cover1.jpg'); ?>">
		    ...
		    <div class="carousel-item">
		      <img class="d-block img-fluid carousel-img" src="<?php echo get_theme_mod('slider_image2', get_bloginfo('template_url').'/assets/cover2.jpg'); ?>">
		      <div class="carousel-caption">
		    ...
		    <div class="carousel-item">
		      <img class="d-block img-fluid carousel-img" src="<?php echo get_theme_mod('slider_image3', get_bloginfo('template_url').'/assets/cover3.jpg'); ?>">
		      <div class="carousel-caption">
